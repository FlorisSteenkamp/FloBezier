    ...
    function() {
        {
            ...
            expect(r_.length).toEqual(r.length);
        }

        {
            ...
            expect(r).toEqual([[[1,1],[4,4]]]);
        }

        {
            const ps = [[1,1],[2,2],[3,3]];
            expect(() => fitQuadsToCubic(ps,2**-10)).toThrow();
        }

        {
            const ps = [[0,0],[1,1],[2,1],[3,0]];
            expect(fitQuadsToCubic(ps,2**-10)).toEqual([
                [[0,0],[1.5,1.5],[3,0]]
            ]);
        }
