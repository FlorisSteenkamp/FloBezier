...
import type { IterationExtras } from './debug.js';
...
function checkIntersectionInRanges(
    ...
    if (globalThis.__debug__ !== undefined && !globalThis.__debug__.already) {
        (newIter as IterationExtras).parent = globalThis.__debug__.currentIter;
    ...
    function split() {
        ...
        if (gtSpan >= ftSpan) {
            ...
            if (globalThis.__debug__ !== undefined && !globalThis.__debug__.already) {
                (iter1 as IterationExtras).parent = globalThis.__debug__.currentIter;
                (iter2 as IterationExtras).parent = globalThis.__debug__.currentIter;
