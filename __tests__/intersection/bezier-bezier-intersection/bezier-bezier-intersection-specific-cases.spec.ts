    ...
    function() {
        {
            ...
            const xs = bezierBezierIntersection(psA, psB);
            expect(omitPT(xs)).toBeNearly(2**4, [
                {
                    kind: 6,
                    box: [[1.5,0.75],[1.5,0.75]],
                    ri1: { t: 0.5, tS: 0.5, tE: 0.5, multiplicity: 1 },
                    ri2: { t: 0.5, tS: 0.5, tE: 0.5, multiplicity: 1 },
                }
            ]);
            testXs(psA,psB);
        }
    ...
    function() {
        ...
        expect(omitPT(xs)).toBeNearly(2**4, [
            { 
                ...
                kind: 1,
                ri1: { t: 0.125, tS: 0.125, tE: 0.125, multiplicity: 1 },
                ri2: { t: 0.75, tS: 0.75, tE: 0.75, multiplicity: 1 }
            }
        ]);
        testXs(psA,psB);
    });
    ...
    function() {
        {
            ...
            expect(omitPT(xs)).toBeNearly(2**4, [
                {
                    kind: 5, box: [[1,1], [1,1]],
                    ri1: { t: 0, tS: 0, tE: 0, multiplicity: 1 }, 
                    ri2: { t: 0, tS: 0, tE: 0, multiplicity: 1 }
                },
                {
                    kind: 5, box: [[2,2], [2,2]],
                    ri1: { t: 1, tS: 1, tE: 1, multiplicity: 1 }, 
                    ri2: { t: 0.5, tS: 0.5, tE: 0.5, multiplicity: 1 }, 
                }
            ]);
            testXs(psA,psB);
...

        {
            ...
            expect(omitPT(xs)).toEqual([
                ...
                },
                {
                    kind: 5, box: [[2,2],[2,2]],
                    ri1: { t: 1, tS: 1, tE: 1, multiplicity: 1 },
                    ri2: { t: 1, tS: 1, tE: 1, multiplicity: 1 }
                }
            ]);
        }
    });
    ...
    function() {
        ...
        expect(omitPT(xs)).toBeNearly(2**4, [
            { 
                ...
                kind: 1,
                ri1: { t: 0.1757734726937926, tS: 0.1757734726937926, tE: 0.17577347269379281, multiplicity: 1 },
                ri2: { t: 0.4635510011070456, tS: 0.4635510011070456, tE: 0.46355100110704583, multiplicity: 1 },
            },
            { 
                box: [[1.500889349297748,1.500889349297748],[1.5008893492977502,1.5008893492977502]], 
                kind: 1,
                ri1: { t: 0.500889349297749, tS: 0.500889349297749, tE: 0.5008893492977492, multiplicity: 1 },
                ri2: { t: 0.6344882145792289, tS: 0.6344882145792289, tE: 0.6344882145792291, multiplicity: 1 }
            }
        ]);
        testXs(psA,psB);
    });
    ...
    function() {
        {
            ...
            expect(omitPT(xs)).toBeNearly(2**4, [
                { 
                    ...
                    box: [[1,1],[1,1]],
                    ri1: { t: 0, tS: 0, tE: 0, multiplicity: 1 },
                    ri2: { t: 0.20530387392964167, tS: 0.20530387392964167, tE: 0.2053038739296419, multiplicity: 1 }
                },
                { 
                    kind: 5,
                    box: [[1,1],[1,1]],
                    ri1: { t: 0, tS: 0, tE: 0, multiplicity: 1 },
                    ri2: { t: 0.885605216979449, tS: 0.885605216979449, tE: 0.8856052169794493, multiplicity: 1 }
                }
            ]);
            testXs(psA,psB);
        }
    ...
    function() {
        {
            ...
            const xsA1 = omitPT(bezierBezierIntersection(psA1, psB));
            expect(xsA1).toBeNearly(2**4, [
                { 
                    box: [[-2.235581769582615,1.0999999999994616],[-2.235581769582608,1.0999999999994639]],
                    kind: 1,
                    ri1: { t: 1.7915091821658774e-12, tS: 1.7912871375609524e-12, tE: 1.7915091821658774e-12, multiplicity: 1 },
                    ri2: { t: 0.661985479297476, tS: 0.661985479297476, tE: 0.6619854792974762, multiplicity: 1 },
                }
            ]);
            testXs(psA1,psB);
            ...
            expect(bezierBezierIntersection(psA2, psB)).toEqual([]);
            testXs(psA2,psB);

            // https://www.desmos.com/calculator/imobftrknc
            const psA3 = [[-2.2355817696,1.1],[1,1],[2,1],[3,4]];
            const xsA3 = omitPT(bezierBezierIntersection(psA3, psB));

            expect(xsA3).toBeNearly(2**4, [
                {
                    box: [[-2.235581769582615,1.0999999999994616], [-2.235581769582608,1.0999999999994639]],
                    kind: 1,
                    ri1: { t: 1.791509182169028e-12, tS: 1.791287137564103e-12, tE: 1.791509182169028e-12, multiplicity: 1 },
                    ri2: { t: 0.6619854792974761, tS: 0.6619854792974761, tE: 0.6619854792974763, multiplicity: 1 }
                },
                {
                    box: [[2.8143224135797613,3.4781434202638417], [2.8143224135797715,3.4781434202638515]],
                    kind: 1,
                    ri1: { t: 0.938282653820259, tS: 0.9382826538202588, tE: 0.938282653820259, multiplicity: 1 },
                    ri2: { t: 0.056172565234172495, tS: 0.056172565234172266, tE: 0.05617256523417249, multiplicity: 1 }
                },
                {
                    box: [[2.8745991633907635,3.63975904454619], [2.8745991633907892,3.63975904454621]],
                    kind: 1,
                    ri1: { t: 0.9582539356878587, tS: 0.9582539356878587, tE: 0.9582539356878589, multiplicity: 1 },
                    ri2: { t: 0.19375978546061032, tS: 0.19375978546061032, tE: 0.19375978546061054, multiplicity: 1 },
                }
            ]);
            testXs(psA3,psB);
        }
    ...
    function() {
        ...
        expect(omitPT(xs)).toBeNearly(2**4, [
            { 
                ...
                kind: 1,
                ri1: { t: 0.3891497303695116, tS: 0.3891497303695116, tE: 0.38914973036951184, multiplicity: 1 },
                ri2: { t: 0.0558163970361784, tS: 0.055816397036178175, tE: 0.0558163970361784, multiplicity: 1 },
            }
        ]);
...
function testXs(
    ...
    expect(orderedR).toEqual(true);

    // @ts-ignore
    expect(xs).toBeNearly(2**16, xsR_);
}
