    ...
    function() {
        ...
        expect(xs).toBeNearly(2**4, [
            { 
                ...
                ri: { t: 0.24764498406887872, tS: 0.24764498406887858, tE: 0.2476449840688788, multiplicity: 1 },
            ...
            { 
                ...
                ri: { t: 0.9996679343869084, tS: 0.9996679343869084, tE: 0.9996679343869086, multiplicity: 1 },
            ...
            expect(xs).toBeNearly(2**4, [
                {
                    ...
                    ri: { t: 0.321407714824162, tS: 0.321407714824162, tE: 0.32140771482416225, multiplicity: 1 },
        ...
        }
        {
            ...
            expect(xs).toBeNearly(2**4, [
                { 
                    ...
                    ri: { t: 0.4472135954999579, tS: 0.4472135954999579, tE: 0.44721359549995815, multiplicity: 1 },
    ...
    function() {
        {
            ...
            const ps = [[1,1]];
            expect(() => circleBezierIntersection({ center: [1,1], radius: 1}, ps)).toThrow();
        }
        {
