...
describe('interval box', function() {
    ...
    function() {
        {
            ...
            expect(isPointInBoxE(pS_, box)).toEqual(false);

            expect(box).toBeNearly(2**6, [
    ...
    function() {
...

        {
            ...
            const tE = 0.125;
            const i = [tS, tE];
            expect(() => getIntervalBox(ps, i)).toThrow();
        }
    });
});
