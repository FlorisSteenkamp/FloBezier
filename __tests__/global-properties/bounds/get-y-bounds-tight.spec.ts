...
describe('getYBoundsTight', function() {
    it('it should find correct y bounds for some lines', 
    function() {
        ...
        expect(rR).toBeNearly(2**6, reverseYBoundTs(expected));
    });

    it('it should find correct y bounds for some quadratic bezier curves', 
    function() {
    ...
    it('it should find correct y bounds for some cubic bezier curves', 
    function() {
        ...
        expect(r).toBeNearly(2**8, expected);
        expect(rR).toBeNearly(2**12, reverseYBoundTs(expected));
    });
});
