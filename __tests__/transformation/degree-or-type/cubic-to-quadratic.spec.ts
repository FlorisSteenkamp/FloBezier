    ...
    function() {
        {
            ...
            expect(e1).toBeNearly(2**8, e1_);
            expect(e2).toBeNearly(2**8, e2_);
        }

        {
            for (let i=0; i<10; i++) {
                ...
                expect(e1).toBeNearly(2**12, e1_);
                expect(e2).toBeNearly(2**12, e2_);
            }
        }
