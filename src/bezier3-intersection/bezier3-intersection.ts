...
import { checkIntersectionInRanges } from './check-intersection-in-ranges';
...
function bezier3Intersection(
    ...
    if (typeof _bez_debug_ !== 'undefined') {
        ...
        _bez_debug_.generated.elems.fatLine.push(
            { l: [[0,0],[1e-10,1e-10]], minD: 0, maxD: 0 }
        );
    }
    ...
    while (stack.length !== 0) {
        ...
        let { newIterations, t1 } = 
            checkIntersectionInRanges(ps1_, ps2_, tRange1, tRange2, idx, δ);
