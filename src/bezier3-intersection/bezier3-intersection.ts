...
import { calcOtherT } from './calc-other-t';
import { geoClip } from './geo-clip';
...
interface IterationTree {
    parent: IterationTree;
    children: IterationTree[];
    iteration: Iteration;
}
...
function bezier3Intersection(
    ...
    if (typeof _bez_debug_ !== 'undefined') {
        ...
        _bez_debug_.generated.elems.fatLine.push(
            new FatLine([[0,0],[1e-10,1e-10]], 0, 0) // unused
        );
    }
    ...
    */
    ...
    function f(
        ...
        //if (doA) {
            dQ = getDistanceToLineFunction([Q0,Q3]);
