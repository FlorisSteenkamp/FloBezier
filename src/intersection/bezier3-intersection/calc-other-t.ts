...
import { closestPointOnBezier as _closestPointOnBezier } from '../../simultaneous-properties/closest-point-on-bezier/closest-point-on-bezier';
import { evalDeCasteljau as _evalDeCasteljau } from '../../local-properties-at-t/t-to-xy/eval-de-casteljau';
import { closestPointOnBezierExclEndpoints as _closestPointOnBezierExclEndpoints } from './closest-point-on-bezier';

const squaredDistanceBetween = _squaredDistanceBetween;
const closestPointOnBezier = _closestPointOnBezier;
const evalDeCasteljau = _evalDeCasteljau;
const closestPointOnBezierExclEndpoints = _closestPointOnBezierExclEndpoints;
...
function calcOtherT(
    ...
    //let p = evaluate(P)(t);
    let p = evalDeCasteljau(P, t);
    let p_ = closestPointOnBezierExclEndpoints(Q, p);
