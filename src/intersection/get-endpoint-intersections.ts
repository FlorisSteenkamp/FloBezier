...
function getEndpointIntersections(
    ...
    const minD2S1 = squaredDistanceBetween(evaluate_anyBitlength_exact(ps2, t2S1).map(eEstimate), p1S)
    ...
    const minD2E1 = squaredDistanceBetween(evaluate_anyBitlength_exact(ps2, t2E1).map(eEstimate), p1E)
    ...
    const minD1S2 = squaredDistanceBetween(evaluate_anyBitlength_exact(ps1, t1S2).map(eEstimate), p2S)
    ...
    const minD1E2 = squaredDistanceBetween(evaluate_anyBitlength_exact(ps1, t1E2).map(eEstimate), p2E)
