...
import { twoProduct, qMultBy2, qMultDouble2, qMultQuad, qAddQuad } from "flo-numerical";
...
// TODO - better docs
function getCoeffs3x2Quad(ps1: number[][], ps2: number[][]) {
    let { 
    ...
    return {
        ...
        errBound: [v6_, v5_, v4_, v3_, v2_, v1_, v0_].map(c => γγ3*c)
    };
}


export { getCoeffs3x2Quad }
