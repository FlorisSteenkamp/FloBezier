...
function getCoeffs2x3Exact_(ps1: number[][], ps2: number[][]) {
    ...
    let c0c2 = twoProduct(c0,c2);
    let c0c3 = twoProduct(c0,c3);
    let c0d0 = twoProduct(c0,d0);
    let c0d1 = twoProduct(c0,d1);
    let c0d2 = twoProduct(c0,d2);
    let c0d3 = twoProduct(c0,d3);
    let c1c1 = twoProduct(c1,c1);
    let c1c2 = twoProduct(c1,c2);
    let c1c3 = twoProduct(c1,c3);
    let c1d0 = twoProduct(c1,d0);
    let c1d1 = twoProduct(c1,d1);
    let c1d2 = twoProduct(c1,d2);
    let c1d3 = twoProduct(c1,d3);
    let c2d1 = twoProduct(c2,d1);
    let c2c2 = twoProduct(c2,c2);    
    let c2c3 = twoProduct(c2,c3);
    let c2d0 = twoProduct(c2,d0);
    let c2d2 = twoProduct(c2,d2);
    let c2d3 = twoProduct(c2,d3);
    let c3c3 = twoProduct(c3,c3);
    let c3d0 = twoProduct(c3,d0);
    let c3d1 = twoProduct(c3,d1);
    let c3d2 = twoProduct(c3,d2);
    let c3d3 = twoProduct(c3,d3);
    let d0d0 = twoProduct(d0,d0);
    let d0d1 = twoProduct(d0,d1);
    let d0d2 = twoProduct(d0,d2);
    let d0d3 = twoProduct(d0,d3);
    let d1d1 = twoProduct(d1,d1);
    let d1d2 = twoProduct(d1,d2);
    let d3d3 = twoProduct(d3,d3);
    let d2d2 = twoProduct(d2,d2);
    let d2d3 = twoProduct(d2,d3);
    let d1d3 = twoProduct(d1,d3);
