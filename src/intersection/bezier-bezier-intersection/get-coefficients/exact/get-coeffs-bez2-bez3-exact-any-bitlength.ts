...
import { getCoeffsBez1Bez3ExactAnyBitlength } from "./get-coeffs-bez1-bez3-exact-any-bitlength";
 ...
 * @doc mdx
 */
function getCoeffsBez2Bez3ExactAnyBitlength(ps1: number[][], ps2: number[][]) {
    /** ps1 in power bases */
    ...
    if (eSign(ps1pb[0][0]) === 0 && eSign(ps1pb[1][0]) === 0) {
        ...
        return getCoeffsBez1Bez3ExactAnyBitlength([ps1[0],ps1[2]], ps2);
    }
    ...
    if (eSign(c3) === 0 && eSign(d3) === 0) {
        ...
        return getCoeffsBez2Bez2ExactAnyBitlength(ps1, toQuadraticFromCubic(ps2));
    }
...
export { getCoeffsBez2Bez3ExactAnyBitlength }
