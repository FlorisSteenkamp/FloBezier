import { getXYAnyBithlengthInclErrorCounters3 } from '../../to-power-basis/double/get-xy-incl-error-counters';
 ...
 * @doc mdx
 */
function getImplicitForm3InclErrorCounters(ps: number[][]) {
    // The implicit form is given by:
    // vₓₓₓx³ + vₓₓᵧx²y + vₓᵧᵧxy² + vᵧᵧᵧy³ + vₓₓx² +vₓᵧxy + vᵧᵧy² + vₓx + vᵧy + v = 0

    const {
        coeffs: [[a3,a2,a1,a0],[b3,b2,b1,b0]],
        errorBound: [[_a3,_a2,_a1,_a0],[_b3,_b2,_b1,_b0]]
    } = getXYAnyBithlengthInclErrorCounters3(ps);
...
export { getImplicitForm3InclErrorCounters }
