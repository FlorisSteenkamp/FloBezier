 ...
 */
declare let getBoundingHull: typeof grahamScan;
/** Alias of κ. */
/**
...
export { getXY, getDxy, getDdxy, getDddxy, getDxyAt1, getDdxyAt1, getDxyAt0, getDdxyAt0, evaluateHybridQuadratic, κ, curvature, tangent, normal, getTAtLength, toCubic, cubicToQuadratic, fromPowerBasis, toHybridQuadratic, reverse, from0ToT, fromTTo1, fromTo, fromToPrecise, splitAt, splitAtPrecise, splitByMaxCurveLength, splitByMaxCurvature, splitByCurvatureAndLength, clone, toString, quadToPolyline, toExpansion, toEstimation, getImplicitForm3, getImplicitForm3Dd, getImplicitForm3Exact, getImplicitForm2, getImplicitForm2Dd, getImplicitForm2Exact, getImplicitForm1, getImplicitForm1Dd, getImplicitForm1Exact, getBounds, getBoundingHull, getBoundingBoxTight, getBoundingBox, lengthUpperBound, lengthSquaredUpperBound, getIntervalBox, getCurvatureExtrema, totalCurvature, totalAbsoluteCurvature, length, totalLength, isQuadObtuse, flatness, isLine, isHorizontalLine, isVerticalLine, isSelfOverlapping, getHodograph, isCubicReallyQuad, toQuadraticFromCubic, getInflections, equal, getInterfaceCcw, areBeziersInSameKFamily, closestPointOnBezierPrecise, getTangentPolyFromPoint, getTangentPolyFromPointExact, hausdorffDistance, hausdorffDistanceCandidates, getEndpointIntersections, inversion01Precise, bezierBezierIntersection, getCoeffsBezBez, getOtherTs, intersectBoxes, areBoxesIntersecting, circleBezierIntersectionD, circleBezierIntersection, bezierSelfIntersection, bezierFromPart, generateCuspAtHalf3, cubicThroughPointGiven013, getIntervalBoxDd, evalDeCasteljau, evalDeCasteljauWithErr, evalDeCasteljauWithErrDd, evaluate_anyBitlength_exact, isPointOnBezierExtension, getCoeffsBez3Bez3, getCoeffsBez3Bez3Dd, getCoeffsBez3Bez3Exact, getCoeffsBez3Bez2, getCoeffsBez3Bez2Dd, getCoeffsBez3Bez2Exact, getCoeffsBez3Bez1, getCoeffsBez3Bez1Dd, getCoeffsBez3Bez1Exact, getCoeffsBez2Bez3, getCoeffsBez2Bez3Dd, getCoeffsBez2Bez3Exact, getCoeffsBez2Bez2, getCoeffsBez2Bez2Dd, getCoeffsBez2Bez2Exact, getCoeffsBez2Bez1, getCoeffsBez2Bez1Dd, getCoeffsBez2Bez1Exact, getCoeffsBez1Bez3, getCoeffsBez1Bez3Dd, getCoeffsBez1Bez3Exact, getCoeffsBez1Bez2, getCoeffsBez1Bez2Dd, getCoeffsBez1Bez2Exact, getCoeffsBez1Bez1, getCoeffsBez1Bez1Dd, getCoeffsBez1Bez1Exact, getCoeffsBez3, getCoeffsBez3Dd, getCoeffsBez3Exact, getCoeffsBez3Exact_NoPrecondition, closestPointOnBezier, evaluate, evaluateDdxy, evaluateDxy };
export { BezierPart, X };
