 ...
 * @doc mdx
 */
function toPowerBasis_1stDerivativeErrorCounters(ps: number[][]): number[][] {
	if (ps.length === 4) {
...
/** @internal */
function toPowerBasis1_1stDerivativeErrorCounters(
		ps: number[][]): number[][] {
...
/** @internal */
function toPowerBasis2_1stDerivativeErrorCounters(
		ps: number[][]): number[][] {
...
/** @internal */
function toPowerBasis3_1stDerivativeErrorCounters(
		ps: number[][]): number[][] {
