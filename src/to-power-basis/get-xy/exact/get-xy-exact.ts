...
function getXYExact(
	...
	if (ps.length === 4) {
		return getXYExact3(ps);
	}

	if (ps.length === 3) {
		return getXYExact2(ps);
	}

	return getXYExact1(ps);
}
...
export { 
	getXYExact1, getXYExact2, getXYExact3,
	getXYExact
}
