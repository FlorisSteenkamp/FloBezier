 ...
 * @doc mdx
 */
function getDxyErrorCounters(ps: number[][]): number[][] {
	if (ps.length === 4) {
...
export { 
	getDxyErrorCounters,
	getDxy1ErrorCounters,
	getDxy2ErrorCounters,
	getDxy3ErrorCounters
}
