 ...
 * @doc
 */
function toPowerBasisDdWithRunningError(
		ps: number[][]): {
			coeffs: number[][][];
			errorBound: number[][];
		} {
...
/** @internal */
function toPowerBasis3DdWithRunningError(
		ps: number[][]): {
...
/** @internal */
function toPowerBasis2DdWithRunningError(
		ps: number[][]): {
...
/** @internal */
function toPowerBasis1DdWithRunningError(
...
/** @internal */
function toPowerBasis0DdWithRunningError(
