// TODO - this function is till incomplete since no special cases are considered yet
 ...
 * @doc
 *//*
function areBeziersExtensionsIdentical(
        ps1: number[][], 
        ps2: number[][]) {
...
export { areBeziersExtensionsIdentical }
*/