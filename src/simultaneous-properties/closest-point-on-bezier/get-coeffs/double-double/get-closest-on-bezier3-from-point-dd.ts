 ...
 * @param p 
 */
function getClosestOnBezier3FromPointDd(
    ...
    const t5 = qmd(
        6,
        qaq(
            qaq(qaq(qaq(qdq(x33,x23),qdq(x00,x01)),q1),qdq(q3,q2)),
            qaq(qaq(qaq(qdq(y33,y23),qdq(y00,y01)),r1),qdq(r3,r2))
        )
    );
    ...
    const t4 = qmd(
        5,
        qaq(
            qdq(qaq(qaq(x23,qmd(5,x01)),qmd(3,q2)),qm2(qaq(qaq(q1,qm2(q3)),qmd(3,x00)))),
            qdq(qaq(qaq(y23,qmd(5,y01)),qmd(3,r2)),qm2(qaq(qaq(r1,qm2(r3)),qmd(3,y00))))
        )
    );
    ...
    const t3 = qm4(qaq(
        qdq(qdq(q1,qmd(3,(qdq(q2,qm2(q3))))),qmd(5,qdq(qm2(x01),qmd(3,x00)))),
        qdq(qdq(r1,qmd(3,(qdq(r2,qm2(r3))))),qmd(5,qdq(qm2(y01),qmd(3,y00))))
    ));
    ...
    const t2 = qmd(
        3,
        qaq(
            qdq(q2,qm2(qdq(qm2(q3),qmd(5,qdq(x01,qm2(x00)))))),
            qdq(r2,qm2(qdq(qm2(r3),qmd(5,qdq(y01,qm2(y00))))))
        )
    );
    ...
    //              (r3 - 5*(y01 - 3*y00)));
    const t1 = qm2(qaq(
        qdq(q3,qmd(5,(qdq(x01,qmd(3,x00))))),
        qdq(r3,qmd(5,(qdq(y01,qmd(3,y00)))))
    ));
...
export { getClosestOnBezier3FromPointDd }
