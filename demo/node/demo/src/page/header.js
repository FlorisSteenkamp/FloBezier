...
function Header() {
    return (React.createElement("header", { style: {
        ...
        React.createElement("div", { style: { display: 'flex', alignItems: 'baseline', gap: '12px', flexWrap: 'wrap' } },
            React.createElement("span", { style: {
                    fontSize: '22px', fontWeight: 800, letterSpacing: '-0.01em',
                    color: '#1e7a34', fontFamily: 'ui-monospace, Menlo, Consolas, monospace'
                } }, "flo-bezier-3"),
            React.createElement("span", { style: { fontSize: '16px', color: '#2f4a34', fontWeight: 600, marginLeft: '14px' } },
                React.createElement("em", { style: { fontWeight: 800, fontStyle: 'italic', color: '#2b8a3e' } }, "The"),
                " bezier curve library")),
        React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '14px' } },
            React.createElement("span", { style: { fontSize: '12.5px', color: '#6a7a6a', fontStyle: 'italic' } }, "Ultra-fast, stupid-accurate, numerically-bulletproof."),
            React.createElement("a", { href: GITHUB_URL, target: "_blank", rel: "noopener noreferrer", style: {
                ...
                React.createElement("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true" },
                ...
                "GitHub"),
            React.createElement("a", { href: NPM_URL, target: "_blank", rel: "noopener noreferrer", style: {
                    display: 'inline-flex', alignItems: 'center', gap: '6px',
