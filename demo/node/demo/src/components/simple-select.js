...
function SimpleSelect(props) {
    ...
    return (React.createElement("div", { ref: rootRef, style: {
            position: 'relative',
        ...
        label !== undefined &&
            React.createElement("div", { style: { fontSize: '11px', color: '#5a5a5a', marginBottom: '3px' } }, label),
        React.createElement("button", { type: "button", onClick: toggleOpen, onKeyDown: onButtonKeyDown, style: {
                minWidth: '270px',
                width: '100%',
                display: 'flex',
                alignItems: 'center',
            ...
            React.createElement("span", { style: { overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, value),
        ...
        open &&
            React.createElement("ul", { role: "listbox", style: {
                    position: 'absolute',
                    zIndex: 10,
                    left: 0,
                    right: 0,
                ...
                return (React.createElement("li", { key: option, ref: el => { optionRefs.current[idx] = el; }, role: "option", "aria-selected": selected, onClick: () => select(option), onMouseEnter: () => setActiveIndex(idx), style: {
                        padding: '6px 12px',
                        lineHeight: '18px',
                        boxSizing: 'border-box',
                        cursor: 'pointer',
