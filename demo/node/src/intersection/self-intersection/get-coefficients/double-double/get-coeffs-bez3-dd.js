 ...
 * @internal
 */
function getCoeffsBez3Dd(ps) {
    const { coeffs: [[a3, a2, a1], [b3, b2, b1]], errorBound: [[a3_, a2_, a1_], [b3_, b2_, b1_]] } = toPowerBasis3DdWithRunningError(ps);
    const $a3 = a3[1];
    const $a2 = a2[1];
    const $a1 = a1[1];
    const $b3 = b3[1];
...
//# sourceMappingURL=get-coeffs-bez3-dd.js.map