 ...
 * @internal
 */
function getCoeffsBez1Bez2(ps1, ps2) {
    const { coeffs: { vₓ, vᵧ, v }, errorBound: { vₓ_, vᵧ_, v_ } } = getImplicitForm1WithRunningError(ps1);
    const { coeffs: [[c2, c1, c0], [d2, d1, d0]], errorBound: [[c2_, c1_], [d2_, d1_]] // `c0` and `d0` are error free
...
//# sourceMappingURL=get-coeffs-bez1-bez2.js.map