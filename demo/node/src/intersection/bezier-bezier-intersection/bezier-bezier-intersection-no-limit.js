"use strict";
// TODO - finish - useful also for line-line intersections
...
// import { bezierBezierIntersectionBoundlessBoth } from './bezier-bezier-intersection-boundless-both.js';
...
//  * curves) WITHOUT limiting their `t` within [0,1], i.e. `t ∈ [-∞,+∞]`.
//  * 
...
//  * first bezier curve
//  * * if the two curves have an infinite number of intersections then `undefined`
//  * will be returned
//  * 
...
//     }
//     const ris2 = bezierBezierIntersectionBoundlessBoth(ps1, ps2);
//     if (ris2 === undefined) {
...
//# sourceMappingURL=bezier-bezier-intersection-no-limit.js.map