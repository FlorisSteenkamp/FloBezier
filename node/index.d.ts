...
/** Alias of κ. */
export { Extrema, getXY, getDxy, getDdxy, getDddxy, getDxyAt1, getDdxyAt1, getDxyAt0, getDdxyAt0, getDddxyDd, getDdxyDd, getDxyDd, getXYDd, getXYExact, getDxyExact, getDdxyExact, getDddxyExact, getXYWithRunningError, getXYDdWithRunningError, getXYErrorCounters, getDxyErrorCounters, κ, curvature, tangent, normal, getTAtLength, toCubic, fromPowerBasis, toHybridQuadratic, reverse, fromTo, splitByMaxCurveLength, splitByMaxCurvature, splitByCurvatureAndLength, clone, toString, quadToPolyline, toExpansion, toEstimation, getImplicitForm3, getImplicitForm3Dd, getImplicitForm3ErrorCounters, getImplicitForm3DdWithRunningError, getImplicitForm3Exact, getImplicitForm2, getImplicitForm2Dd, getImplicitForm2ErrorCounters, getImplicitForm2DdWithRunningError, getImplicitForm2Exact, getImplicitForm1, getImplicitForm1Dd, getImplicitForm1ErrorCounters, getImplicitForm1DdWithRunningError, getImplicitForm1Exact, getBounds, getXBoundsTight, getYBoundsTight, getBoundingHull, getBoundingBoxTight, getBoundingBox, controlPointLinesLength, getIntervalBox, getCurvatureExtrema, totalCurvature, totalAbsoluteCurvature, length, area, totalLength, isQuadObtuse, flatness, isCollinear, isHorizontal, isVertical, isSelfOverlapping, getHodograph, isReallyPoint, isQuadReallyLine, isCubicReallyQuad, toQuadraticFromCubic, getInflections, equal, γ, γγ, areBeziersInSameKFamily, closestPointOnBezierCertified, getInterfaceRotation, closestPointOnBezier, generateQuarterCircle, hausdorffDistanceOneSided, hausdorffDistance, tFromXY, bezierBezierIntersection, getCoeffsBezBez, intersectBoxes, areBoxesIntersecting, getClosestSquareDistanceToRect, circleBezierIntersection, bezierSelfIntersection, generateCuspAtHalf3, generateSelfIntersecting, cubicThroughPointGiven013, getIntervalBoxDd, evalDeCasteljau, evalDeCasteljauError, evalDeCasteljauWithErr, evalDeCasteljauWithErrDd, evaluateExact, isPointOnBezierExtension, getCoeffsBez3WithRunningError, getCoeffsBez3Exact, evaluate, evaluateDdxy, evaluateDxy, evaluateDxyExact, evaluateDdxyExact, getDdxyAt0Exact, getDdxyAt1Exact, getDxyAt0Exact, getDxyAt1Exact, evalDeCasteljauDd, bezierBezierIntersectionBoundless, getEndpointIntersections, bezier3Intersection, getControlPointBox, fitQuadsToCubic, getXY3DdWithRunningError, lineToQuadratic, getFootpointPoly, getFootpointPolyDd, getFootpointPolyExact, getInterfaceCcw, compareCurvaturesAtInterface };
