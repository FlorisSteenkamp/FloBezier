import { expansionProduct, eDiff, scaleExpansion2, fastExpansionSum, growExpansion, eSign, eAbs, eToDd, eMultByNeg2, eEstimate, eCompare } from 'big-float-ts';
import { ddNegativeOf, ddAddDd, ddMultBy2, ddDivDd, twoDiff, twoSum, sqrtWithErr, divWithErr, ddSqrt } from 'double-double';
