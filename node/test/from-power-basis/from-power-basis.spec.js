 ...
 */
function testFromPowerBasis(ps) {
    const xy = getXY(ps);
...
describe('fromPowerBasis', function () {
    it('it should correctly convert from power basis to Bernstein basis', function () {
        {
            const pss = [
                [[3, 3]],
                [[3, 5], [7, 1]],
...
//# sourceMappingURL=from-power-basis.spec.js.map