...
describe('helpers', function () {
    it('should make sure the test helpers work as intended', function () {
        {
        ...
        }
        {
            ...
            const toStr = heapToStr(v => v.toString());
        ...
        }
        {
            ...
            expect(() => subtractShewchuk(1, 3)).to.throw();
        }
        {
