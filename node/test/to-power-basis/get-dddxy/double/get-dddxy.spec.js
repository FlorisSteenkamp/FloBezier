...
describe('getDddxy', function () {
    it('it should get the 3rd derivative of the power basis representation of some bezier curves (in double precision)', function () {
        {
        ...
        // some edge cases
        {
            const p = [1, 1];
            const ps = [p, p, p, p, p];
            expect(() => getDddxy(ps)).to.throw();
        }
    });
});
//# sourceMappingURL=get-dddxy.spec.js.map