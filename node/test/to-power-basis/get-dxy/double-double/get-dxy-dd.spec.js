...
import { getDxy, getDxyDd } from '../../../../src/index.js';
import { eEstimate } from 'big-float-ts';
use(nearly);
describe('getDxyDd', function () {
    it('it should get the derivative of the power basis representation of some bezier curves (in double-double precision)', function () {
        {
        ...
        // some edge cases
        {
            const p = [1, 1];
            const ps = [p, p, p, p, p];
            expect(() => getDxyDd(ps)).to.throw();
        }
    });
});
//# sourceMappingURL=get-dxy-dd.spec.js.map