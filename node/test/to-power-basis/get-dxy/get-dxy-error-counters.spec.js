...
describe('getDxyErrorCounters', function () {
    it('it should get tight error bounds when calculating the derivative of the power basis representation of a bezier curve of order <= 3 ', function () {
        const count = 15;
...
//# sourceMappingURL=get-dxy-error-counters.spec.js.map