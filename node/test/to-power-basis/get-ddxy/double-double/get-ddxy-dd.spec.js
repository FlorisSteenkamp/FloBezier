...
describe('getDdxyDd', function () {
    it('it should get the 2nd derivative of the power basis representation of some bezier curves (in double-double precision)', function () {
        {
        ...
        // some edge cases
        {
            const p = [1, 1];
            const ps = [p, p, p, p, p];
            expect(() => getDdxyDd(ps)).to.throw();
        }
    });
});
//# sourceMappingURL=get-ddxy-dd.spec.js.map