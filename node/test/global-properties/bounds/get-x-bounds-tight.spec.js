...
describe('getXBoundsTight', function () {
    it('it should find correct x bounds for some lines', function () {
    ...
    it('it should find correct x bounds for some quadratic bezier curves', function () {
    ...
    it('it should find correct x bounds for some cubic bezier curves', function () {
        {
...
//# sourceMappingURL=get-x-bounds-tight.spec.js.map