...
describe('getBoundingBoxTight', function () {
    it('it should find a correct tight bounding box for some quadratic beziers', function () {
        {
            const ps = [
                [0, 0],
                [1, 1],
    ...
    it('it should find a correct tight bounding box for some cubic beziers', function () {
        {
...
//# sourceMappingURL=get-bounding-box-tight.spec.js.map