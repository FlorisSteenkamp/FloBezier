...
describe('interval box', function () {
    it('it should get a reasonable interval box for some lines', function () {
        {
    ...
    it('it should get a reasonable interval box for some quadratic bezier curves', function () {
        {
    ...
    it('it should get a reasonable interval box for some cubic bezier curves', function () {
        {
...
//# sourceMappingURL=get-interval-box.spec.js.map