...
import { isCollinear, isCubicReallyLine, toCubic } from '../../../src/index.js';
import { getRandomBezier } from '../../helpers/get-random-bezier.js';
const eps = Number.EPSILON;
const u = eps / 2;
function getLineCubic(seed) {
    const _ps = getRandomBezier(128, 52)(1)(seed);
    return toCubic(_ps.map(p => p.map(c => 3 * c)));
}
describe('isCubicReallyLine', function () {
    it('it should correctly check that some cubic beziers really is a line in disguise or not', function () {
        {
...
//# sourceMappingURL=is-cubic-really-line.spec.js.map