...
import { getRandomBezier, getRandomLine, getRandomPoint, getRandomQuad } from '../helpers/get-random-bezier.js';
import { randomTranslate } from '../helpers/random-translate.js';
use(nearly);
describe('getHodograph', function () {
    it('it should return the correct hodographs of some bezier curves', function () {
        {
...
//# sourceMappingURL=get-hodograph.spec.js.map