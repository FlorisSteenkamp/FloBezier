...
describe('fromTo', function () {
    it('it should return new bezier curves (including error bound) by limiting the `t` domain of some bezier curves', function () {
        {
            const tS = 0.31;
            const tE = 0.77;
...
//# sourceMappingURL=from-to.spec.js.map