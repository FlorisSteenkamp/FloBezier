...
import { curviness, fromTo, generateCuspAtHalf3, length, splitByCurvature } from '../../../src/index.js';
use(nearly);
describe('splitByCurvature', function () {
    it('it should correctly split some bezier curves according to maximum curviness', function () {
        const minTSpan = 2 ** -20;
        {
...
//# sourceMappingURL=split-by-curvature.spec.js.map