...
const abs = Math.abs;
const r = (n) => squares(n) / 4294967295;
function isExtremaLikelyCorrect(ps, extrema) {
    let result = true;
...
describe('getCurvatureExtrema', function () {
    it('it should find the curvature extrema (or rather lack thereof) of some lines', function () {
        {
            // line
            const ps = [[1, 1], [2, 2]];
    ...
    it('it should find the curvature extrema of some quadratic bezier curves', function () {
        {
            // simple quadratic
    ...
    it('it should find the curvature extrema of quadratic bezier curves disguised as cubics', function () {
        {
            for (let i = 0; i < 10; i++) {
                const s = 0;
    ...
    it('it should find the curvature extrema of some cubic bezier curves', function () {
        {
            const rotate_ = rotate(Math.sin(0.1), Math.cos(0.1));
        ...
        */
        {
            ...
            for (let t of extrema.minima) {
                const _t = t - (eps * 2 ** 32);
                const t_ = t + (eps * 2 ** 32);
                assert(curvature(ps, _t) > curvature(ps, t) &&
        ...
        }
        {
            ...
            for (let i = 0; i < 1000; i++) {
                ...
                for (let t of extrema.maxima) {
                    const _t = t - (eps * 2 ** 40);
                    const t_ = t + (eps * 2 ** 40);
                    assert(abs(curvature(ps, _t)) <= abs(curvature(ps, t)) &&
...
//# sourceMappingURL=get-curvature-extrema.spec.js.map