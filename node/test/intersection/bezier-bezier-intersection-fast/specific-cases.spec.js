...
describe('bezierBezierIntersectionFast', function () {
    ...
    ////////////////////////////////////////////////////////////////
    it('it should find intersections between two coinciding points', function () {
        {
            const psA = [[1.021, 1]];
            const psB = [[1.021, 1]];
            const xs = bezierBezierIntersectionFast(psA, psB);
    ...
    // Order 2/2
    ////////////////////////////////////////////////////////////////
    it('it should find intersections between two generic quadratic bezier curves', function () {
        // coinciding points
        {
    ...
    // Order 3/3 and 3/3
    ////////////////////////////////////////////////////////////////
    it('it should find intersections between two generic cubic bezier curves', function () {
        {
    ...
    it('it should find intersections between two cubic bezier curves with overlapping self-intersections', function () {
...
function xToTs(psA, psB) {
    return bezierBezierIntersection(psA, psB).map(xPair => xPair.map(x => [mid(x.ri), mid(x.ri)]));
}
//# sourceMappingURL=specific-cases.spec.js.map