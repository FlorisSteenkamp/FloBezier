...
describe('cubicThroughPointGiven013', function() {
    it('should create the correct cubic though a given point given control points 0, 1 and 3 at time `t`', 
	function() {
        expect(cubicThroughPointGiven013(
            [[1,1], [10.53125,4.8125], ,[18,0.5]], 
            [14.6875,3.34375], 
            0.75
        )).to.be.nearly(2**4,
