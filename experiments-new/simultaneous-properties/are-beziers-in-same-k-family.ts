...
function areBeziersInSameKFamily(
    ...
    // according to Bezout's Theorem. Also, make each parametric `t`-value an 
    // integer power of two to keep the bitlength a minimum (1 in this case).
