import { getImplicitForm3WithRunningError47 } from "../../implicit-form/double/get-implicit-form3-with-running-error-47";
 ...
 * @internal
 */
 function isPointOnBezierExtension3_47(ps: number[][], p: number[]): boolean {
    const [x,y] = p;
    ...
    //---- first pre-filter
    {
        ...
        } = getImplicitForm3WithRunningError47(ps);
    ...
    // error too high - const's try quad precision
    {
        ...
        const { 
            coeffs: { vₓₓₓ, vₓₓᵧ, vₓᵧᵧ, vᵧᵧᵧ, vₓₓ, vₓᵧ, vᵧᵧ, vₓ, vᵧ, v },
            errorBound: { vₓₓₓ_, vₓₓᵧ_, vₓᵧᵧ_, vᵧᵧᵧ_, vₓₓ_, vₓᵧ_, vᵧᵧ_, vₓ_, vᵧ_, v_ }
        } = getImplicitForm3DdWithRunningError47(ps);
...
export { isPointOnBezierExtension3_47 }
