...
import { getImplicitForm1DdWithRunningError } from "../../../src/implicit-form/double-double/get-implicit-form1-dd-with-running-error";
...
import { getImplicitForm1Exact } from '../../../src/implicit-form/exact/get-implicit-form1-exact';
 ...
 */
 function isPointOnBezierExtension1(
...

    {
        ...
        const q7_ = _vₓx_ + _vᵧy_ + abs(q7[1]);
        const h = qaq(q7,v);
