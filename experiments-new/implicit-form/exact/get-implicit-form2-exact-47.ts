import type { ImplicitFormExact2 } from '../../../src/implicit-form/implicit-form-types';
 ...
 * @doc mdx
 */
function getImplicitForm2Exact47(
        ps: number[][]): ImplicitFormExact2 {
...
export { getImplicitForm2Exact47 }
