import { getImplicitForm3InclError } from "../../../../../src/implicit-form/double-with-error-counters/get-implicit-form3-incl-error";
 ...
 * @doc mdx
 */
function getCoeffsBez3Bez1WithRunningError47(ps1: number[][], ps2: number[][]) {
    const { 
...
export { getCoeffsBez3Bez1WithRunningError47 }
