import { getImplicitForm1InclError } from "../../../../../src/implicit-form/double-incl-error/get-implicit-form1-incl-error";
 ...
 * @doc mdx
 */
function getCoeffsBez1Bez1WithRunningError47(ps1: number[][], ps2: number[][]) {
    const { 
        coeffs: { vₓ, vᵧ, v },
...
export { getCoeffsBez1Bez1WithRunningError47 }
